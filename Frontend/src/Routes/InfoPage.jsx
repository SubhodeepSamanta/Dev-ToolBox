...
const InfoPage = () => {
  return (
    <div className='mb-15'>
      <h1 className='text-3xl font-bold ml-4 mt-2'>Information</h1>
      <div className='flex flex-col md:flex-row'>
        <div className="left flex-1">
          ...
          <p className='text-2xl font-bold flex items-center gap-4'>Subhodeep Samanta
            <Link to='' className='bg-blue-100 hover:bg-blue-200 p-2 rounded-full'><Linkedin/></Link>
            <Link to='' className='bg-blue-100 hover:bg-blue-200 p-2 rounded-full'><Github/></Link>
          </p>
      ...
      <div>
        ...
        <div className='flex gap-5 border-t-1 border-gray-200 mx-5 mt-4 p-2'><p className='text-lg font-bold'>Format JSON</p> <p className='text-lg'>POST /api/json/format</p></div>
        <div className='flex gap-5 border-t-1 border-gray-200 mx-5 mt-4 p-2'><p className='text-lg font-bold'>Encode Text</p> <p className='text-lg'>POST /api/base64/encode</p></div>
        <div className='flex gap-5 border-t-1 border-gray-200 mx-5 mt-4 p-2'><p className='text-lg font-bold'>Decode Text</p> <p className='text-lg'>POST /api/base64/decode</p></div>
      </div>
      <div>
