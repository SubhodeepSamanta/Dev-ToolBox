  ...
  return (
    ...
    <div className=' flex flex-col md:flex-row mt-5 h-180 sm:h-160 lg:h-170 xl:180 gap-5 sm:gap-10 px-5 sm:px-10'>
      ...
      <div className='buttons w-full flex flex-row sm:hidden items-center justify-center gap-4 flex-wrap'>
        ...
        {
          mode=='beautify'?
        <select name="indents" id="indents" onChange={(e)=>setIndents(e.target.value)} value={indents} className='border-1 rounded-lg py-1.5 text-sm px-2 cursor-pointer'>
    ...
    {/* large keliye */}
      <div className='buttons hidden w-full sm:flex flex-row items-center justify-center gap-4 mt-5 mb-20'>
        ...
        {
          mode=='beautify'?
        <select name="indents" id="indents" onChange={(e)=>setIndents(e.target.value)} value={indents} className='border-1 rounded-lg py-2 px-2 cursor-pointer'>
          <option value="1">Indents: 1</option>
          <option value="2">Indents: 2</option>
          <option value="3">Indents: 3</option>
          <option value="4">Indents: 4</option>
